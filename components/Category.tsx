          ...
          <div className="grid px-3 pt-4 pb-10 transition transform place-items-center rounded-[2rem] hover:scale-110 hover:bg-white hover:drop-shadow-2xl cursor-default">
            <div className="relative flex mb-4 w-max">
              <img
                ...
                role="presentation"
              />
              <div className="absolute w-12 h-12 rounded-tr-sm rounded-bl-sm -bottom-1 -right-6 bg-primary-light rounded-br-2xl"></div>
            </div>
        ...
        <div className="relative group">
          ...
          <div className="grid px-3 pt-4 pb-10 transition transform place-items-center rounded-[2rem] hover:scale-110 hover:bg-white hover:drop-shadow-2xl cursor-default">
            <div className="relative flex mb-4 w-max">
              ...
              <div className="absolute w-12 h-12 rounded-bl-2xl rounded-tr-2xl -top-2 left-6 bg-primary-light rounded-br-md"></div>
            </div>
            <div className="text-center">
        ...
        <div className="relative group">
          ...
          <div className="grid px-3 pt-4 pb-10 transition transform place-items-center rounded-[2rem] hover:scale-110 hover:bg-white hover:drop-shadow-2xl cursor-default">
            <div className="relative flex mb-4 w-max">
              ...
              <div className="absolute w-10 h-10 rounded-br-sm rounded-tr-xl rounded-bl-xl -top-5 -right-20 bg-primary-light"></div>
            </div>
            <div className="text-center">
              <h4 className="font-sans font-medium text-gray-800">
                Local Events
