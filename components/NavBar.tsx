      ...
      >
        ...
        >
          ...
          >
            ...
            <li>
              <Link
                className="px-2 py-1 rounded-[15px] border-[2px] border-primary text-primary font-default"
                href="/auth/login-candidat"
              >
                Candidat
              </Link>
            ...
            <li>
              <Link
                className="px-2 py-1 rounded-[15px] bg-primary text-white font-default"
                href="/auth/login-entreprise"
              >
                Entreprise
              </Link>
