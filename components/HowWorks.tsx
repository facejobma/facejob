    ...
    return (
        <section className="w-8/12 pb-10 mx-auto mt-32 mb-16">
            <div className="max-w-lg text-center text-gray-800 md:text-start font-poppins">
                ...
                <h2 className="my-4 text-4xl font-bold text-gray-800 md:text-5xl font-volkhof">Explorez les étapes
                    suivantes .</h2>
            </div>
                ...
                >
                    <div className="flex flex-col mt-4 font-poppins">
                        <Image
                            ...
                            height={50}
                        />
                        <p className="mt-4 text-lg">Un emploi de développeur Web est nécessaire</p>
                        ...
                        <div className="flex justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-[#64636e]">
                                    Rejoignez 10 autres personnes
                                </p>
                            </div>
