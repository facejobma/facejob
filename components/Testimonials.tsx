...
export default function Testimonials({}: Props) {
    return (
        <section className="w-full md:px-16 pb-10 mx-auto mb-20">
            <div
                className="relative flex flex-col p-10 items-center justify-between w-full gap-10 md:gap-20 md:flex-row">
                <motion.div
                    initial={{x: -10}}
                ...
                >
                    ...
                    >
                        <SwiperSlide>
                            <div
                                className="relative flex flex-col mt-8 mx-8 mb-4 py-6 px-8 font-poppins bg-white rounded-lg shadow-lg text-[#5E6282]">
                                <Image
