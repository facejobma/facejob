            ...
            <header className="relative w-full py-4 pb-20 bg-optional1">
                ...
                <div className="flex flex-col my-20 md:mx-12 md:flex-row">
                    ...
                    >
                        ...
                        <div
                            className="my-5 text-2xl leading-10 space-y-2 font-bold font-default text-secondary md:text-4xl md:px-2">
                            <p>
                        ...
                        <div className="flex items-center mt-16">
                            <Image src="/Arrow.png" alt="" className="mr-2" width={20} height={20}/>
                            <Link
                                href="#section2"
