...
const LoginForm = (props: { loginFor: "candidate" | "enterprise" }) => {
    ...
    return (
        <div
            className="flex flex-col items-center rounded-lg border border-newColor p-4 font-default max-w-md mx-auto md:max-w-2xl">
            {" "}
        ...
        hover:border-green-200 focus:bg-blue-50 active:bg-blue-100"
                ...
                >
                    <div className="relative flex items-center space-x-10 justify-center">
                        ...
                        />
                        <span
                            className="block w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-green-700 sm:text-base">
