      ...
      >
        ...
        <div className="flex flex-col items-center col-span-2  md:items-start sm:mb-0 md:ml-8">
          ...
          <div className="flex w-full">
            <Link
              href=""
              className="flex items-center justify-center p-2 pl-4 pr-5 bg-black rounded-full pointer-events-none"
            >
              <svg
            ...
            <Link
              href=""
              className="flex items-center justify-center p-2 pl-4 pr-5 ml-2 bg-black rounded-full pointer-events-none"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="19"
