...
const OffresPage: React.FC = () => {
  ...
  // Search is triggered explicitly by the user via the button or Enter
  const handleSearch = () => {
    setCurrentPage(1);
    setOffres([]);
    setHasMore(true);
  ...
  const hasActiveFilters = selectedSector || selectedJob || debouncedSearchQuery || selectedCity || selectedApplicationStatus;
              ...
              <div className="relative">
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-3 md:right-20 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600"
